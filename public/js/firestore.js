...
// Tambahkan parameter 'unit' (atau satuan)
export async function saveProduct(name, price, category, file, unit) { 
    try {
        // ... kode upload imgbb tetap sama ...
        ...
        const docRef = await addDoc(collection(db, "products"), {
            ...
            harga: Number(price),
            gambar: imgbbData.data.url, 
            satuan: unit, // Tambahkan ini agar tersimpan di database
            timestamp: new Date()
        });
